...
{% set materialize_mode = get_config( 'invoice_line_items', var('workspace_id'))['materialize_mode'] %}
{% set primary_key = get_config( 'invoice_line_items', var('workspace_id'))['primary_key'] %}
{% set cursor_field = get_config( 'invoice_line_items', var('workspace_id'))['cursor_field'] %}
{% set full_refresh = get_config( 'invoice_line_items', var('workspace_id'))['full_refresh'] %}
